...
On the top right side of [the repository on GitHub](https://github.com/buluma/ansible-role-openssh), click `fork`. This copies everything to your GitHub namespace.
